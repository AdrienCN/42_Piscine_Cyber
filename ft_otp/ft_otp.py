...
# C = simple counter (0,1 ,2 ...) incremented after each authentication attempt 
...
# TOTP algo, essentially a reimplementation of HOTP(K, C)
# K = Secret key and C = simple counter (0,1 ,2 ...) incremented after each authentication attempt 
# In TOTP C is replaced by T = current time / 30 sec
